...
{
	public class GameCompleteWindowAnimator : WindowsAnimator
	{
		public GameCompleteWindowAnimator(StaticDataService staticData, IFadeInOut fadeInOut) : base(staticData, fadeInOut)
		{
		}
